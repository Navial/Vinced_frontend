    ...
    <h1> My Profil </h1> <br>
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          let infos = await fetch(`https://vinced.azurewebsites.net/articles/user?id=${idMember}`, request);
          infos = await infos.json();
          const items = infos;


          const getImg = await fetch(`https://vinced.azurewebsites.net/articles/pics`);
