...
async function connectedHomePage(){
  ...
  let response = await fetch(`https://vinced.azurewebsites.net/articles?id_member=${idMember}`, request);
...
async function disconnectedHomePage(){
  ...
  let response = await fetch(`https://vinced.azurewebsites.net/articles`, request);
