...
async function getAllAdminMembers() { 
  ...
  const response = await fetch("https://vinced.azurewebsites.net/members/getAdminMembers", options);
...
function addAdminMember(member, adminEmail, body) {
  ...
  banButton.addEventListener('click', async (e) => {
	   try {
		...
		const response = await fetch(`https://vinced.azurewebsites.net/members/banOne`, request);
...
revokeButton.addEventListener('click',async (e) => {
  try {
   ...
   const response = await fetch(`https://vinced.azurewebsites.net/members/demoteOne`, request);
   if(response.status !== 200){
	 // todo notification
...
async function getAllActiveMembers() { 
	...
	const response = await fetch("https://vinced.azurewebsites.net/members/getActiveMembers", options);
...
grantButton.addEventListener('click',async (e) => {
	try {
	 ...
	 const response = await fetch(`https://vinced.azurewebsites.net/members/promoteOne`, request);
...
async function getAllBannedMembers() {  
	...
	const response = await fetch("/https://vinced.azurewebsites.net/members/getBannedMembers", options);
	const allMembers = await response.json();
...
function addBannedMember(member, id, body) {
	...
	unbanButton.addEventListener('click',async (e) => {
		try {
		 ...
		 const response = await fetch(`https://vinced.azurewebsites.net/members/unbanOne`, request);
  ...
  async function memberInfo(){
	...
	let response = await fetch(`https://vinced.azurewebsites.net/members?id=${idMember}`, request);
...
async function banMember() {
  ...
  const options = {
		method: "POST", // *GET, POST, PUT, DELETE, etc.
		  ...
		  const response = await fetch("/https://vinced.azurewebsites.net/members/banOne", options);
    ...
    try {
      ...
      const response = await fetch(`https://vinced.azurewebsites.net/members/login`, request);
...
async function unbanMember() {
  ...
  const options = {
		method: "POST", // *GET, POST, PUT, DELETE, etc.
		  ...
		  const response = await fetch("/https://vinced.azurewebsites.net/members/unbanOne", options);
