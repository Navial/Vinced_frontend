...
// Then, you can use the fetch https://vinced.azurewebsites.net to send a request to the Imgur https://vinced.azurewebsites.net to upload the image.
...
async function renderSellProductPage() {
  const categories = await fetch('https://vinced.azurewebsites.net/categories').then((response) =>
    response.json(),
  );
  ...
  <section class="h-100 gradient-custom">
    ...
    <div class="containercontact">
      ...
      <div class="col-md-11" >
          ...
          <form action="https://vinced.azurewebsites.net/articles" method="POST" >
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const request = fetch('https://https://vinced.azurewebsites.net.imgur.com/3/image', requestOptions);
